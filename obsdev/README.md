...
running command...
$ obsdev (--version)
obsdev/1.1.0-test.1 linux-x64 node-v20.19.5
$ obsdev --help [COMMAND]
USAGE
  $ obsdev COMMAND
...
...
_See code: [src/commands/record.ts](https://github.com/ChrisLFieldsII/obsdev/blob/v1.1.0-test.1/src/commands/record.ts)_
...
_See code: [src/commands/stop-record.ts](https://github.com/ChrisLFieldsII/obsdev/blob/v1.1.0-test.1/src/commands/stop-record.ts)_
